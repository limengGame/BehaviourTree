...
C:\"Program Files"\Unity5.6.7\Editor\Unity.exe -projectPath C:\Resource\Project\Download\BehaviourTree\Tsiu_AIToolkit_Project -quit -batchmode -executeMethod JenkinsAdapter.Build -logFile build.log
